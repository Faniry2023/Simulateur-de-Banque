...
public class TransfertDepot {
	public boolean modifSoldeCurant(int num,double nvSolde,int evoyeur) {
		boolean v = false;
		...
		String hist1 = "Bonjour " +prenom.prenom(num)+"! "+prenom.prenom(evoyeur)+" Vous envoie "+nvSolde + "Ar";
